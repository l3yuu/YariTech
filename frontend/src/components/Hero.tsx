...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-white dark:bg-[#0a0f1a]">
      ...
      <div className="absolute -top-40 right-0 w-[600px] h-[600px] bg-gradient-to-bl from-blue-400/20 via-violet-400/10 to-transparent rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-blue-400/10 to-transparent rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 border border-blue-200/60 dark:border-blue-800/60 mb-6">
              <Sparkles className="w-3 h-3" />
              Built for Filipino Innovators 🇵🇭
            </div>

            {/* Headline */}
            <h1 className="text-5xl sm:text-6xl xl:text-7xl font-extrabold leading-[1.08] tracking-tight text-slate-900 dark:text-white mb-6">
              Freelance‑first.{' '}
              <span className="gradient-text">Built to grow.</span>
            </h1>

            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-lg mx-auto lg:mx-0 mb-10 leading-relaxed">
          ...
          <div className="hidden lg:block">
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl shadow-black/10 dark:shadow-black/30 px-4 py-3 flex items-center gap-3">
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-4 -left-4 bg-gradient-to-r from-blue-600 to-violet-600 rounded-xl px-4 py-3 shadow-xl shadow-blue-500/30">
