  ...
  return (
    <section id="services" className="py-24 bg-slate-50 dark:bg-[#0f172a] relative overflow-hidden">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 w-13 h-13 bg-emerald-500 hover:bg-emerald-600 rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/50 hover:scale-110 transition-all z-50 p-3"
